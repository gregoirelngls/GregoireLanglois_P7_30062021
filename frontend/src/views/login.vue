<template>
  ...
  <div class="card">
    ...
    <p class="card__subtitle" v-if="mode == 'login'">Tu n'as pas encore de compte ? <span class="card__action" @click="createAnAccount()">Créer un compte</span></p>
    <p class="card__subtitle" v-else>Tu as déjà un compte ? <span class="card__action" @click="toLogin()">Se connecter</span></p>
    <div class="form-row">
    ...
    <div class="form-row" v-if="mode == 'create'">
      <input v-model="bio" class="form-row__input" type="text" placeholder="Votre biographie (facultative)"/>
    </div>
    <div class="form-row">
